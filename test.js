...
async function mediadata(fileid) {
  try {
    ...
    if (stdout && stdout.length > 0) {
      ...
      const imagePath = path.join(__dirname, `media_${Date.now()}.jpg`);
